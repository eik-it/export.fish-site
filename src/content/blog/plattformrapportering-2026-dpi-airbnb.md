...
## Hvilke transaksjoner rapporteres?
...
## Hva sender plattformene til Skatteetaten?

Plattformene rapporterer blant annet:

- Totalt beløp utbetalt per kvartal
- Antall transaksjoner per kvartal
- Eventuelle tilbakeholdte gebyrer og skatter
- Ditt navn, adresse og fødselsnummer eller organisasjonsnummer
- Kontoinformasjon

Rapporteringen skjer pr. kalenderår. Skatteetaten mottar data for 2025 i løpet av januar 2026. Fra 2026-inntektsåret er rapporteringen i gang løpende.

Det betyr at Skatteetaten allerede nå har et datagrunnlag som gjør det mulig å sammenligne plattforminntekter med innrapportert skattbar inntekt. Er det avvik, vil det bli oppdaget.
...
Det konkrete rådet er tredelt:

**Gå gjennom tidligere år.** Sjekk om du har levert korrekt selvangivelse for 2023, 2024 og 2025. Plattformene sender nå data for 2025 til Skatteetaten. Frivillig retting er alltid bedre enn å bli oppdaget, og tilleggsskatt ved frivillig retting er lavere enn ved kontroll.

**Få oversikt over hva plattformen har registrert.** Du kan laste ned transaksjonshistorikk fra Airbnb og Booking.com. Sammenlign med hva du selv har oppgitt. Avvik bør avklares.

**Snakk med en regnskapsfører hvis du er usikker.** Spesielt hvis du har høye inntekter, en blanding av privatbruk og utleie, eller driver nær grensene for næringsvirksomhet. Det finnes autoriserte regnskapsførere med spesialkompetanse på korttidsutleie. Se også om [hytteutleiekontrakt og avtalemaler](/blogg/hytteutleiekontrakt-bat-mal/) kan hjelpe deg med å strukturere virksomheten bedre fremover.

For fremtiden: [50 000 kr-grensen for turistfiskebedrifter](/blogg/50000-kr-grensen-turistfiskebedrift/) er ikke den samme grensen som gjelder for skattefritak på hytteutleie, men begge er relevante å kjenne til hvis du driver sammensatt utleie.
...
- [Skatteetaten: Plattformrapportering (DPI)](https://www.skatteetaten.no/bedrift-og-organisasjon/rapportering-og-bransjer/rapporteringsordninger/plattformrapportering/)
